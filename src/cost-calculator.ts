...
function costCalculator(
  ...
  const benefitPercentCost =
    (correctCostHistory.baseSalary * correctCostHistory.benefitsPercent) / 100
  const TotalCost =
    (benefitPercentCost + correctCostHistory.baseSalary) * correctCostHistory.overheadMultiplier
